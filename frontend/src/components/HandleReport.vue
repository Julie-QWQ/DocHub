      ...
      <div class="dialog-body">
        <form @submit.prevent="handleSubmit">
          <div class="info-section">
            <div class="info-row">
              <label class="info-label">举报人</label>
              <div class="info-value">{{ report?.reporter?.real_name || report?.reporter?.username }}</div>
            </div>

            <div class="info-row">
              <label class="info-label">举报原因</label>
              <div class="info-value">{{ formatReportReason(report?.reason) }}</div>
            </div>

            <div class="info-row">
              <label class="info-label">详细描述</label>
              <div class="info-value text-content">{{ report?.description }}</div>
            </div>

            <div class="info-row">
              <label class="info-label">举报时间</label>
          ...
          <div class="form-section">
            ...
            <div class="form-group">
              ...
              <textarea
                ...
                class="form-textarea"
                rows="4"
                :placeholder="formData.approved ? '请说明处理措施' : '请说明驳回理由'"
                maxlength="500"
              ></textarea>
              <div class="char-count">{{ formData.note.length }}/500</div>
            </div>
          </div>
...
const handleSubmit = async () => {
  ...
  loading.value = true
  try {
    await reviewStore.handleReport(props.report!.id, {
